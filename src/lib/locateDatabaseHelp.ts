...
export const LOCATE_DATABASE_RECOMMENDATIONS = [
  ...
  "Use Browse to confirm state.vscdb, or paste the full absolute path — browsers cannot open AppData folders directly.",
] as const;
...
> = {
  ...
  wsl: {
    ...
    notes: [
      ...
      "Browsers cannot open AppData directly — paste the /mnt/c/… path after confirming the file in Explorer.",
    ],
  },
};
