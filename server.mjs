...
const STATIC_EXTENSIONS = /\.(js|css|png|jpg|jpeg|gif|webp|svg|ico|woff2?|ttf|map|json|webmanifest|txt)$/i

function isStaticAsset(reqPath) {
  if (reqPath.startsWith('/assets/')) return true
  if (STATIC_EXTENSIONS.test(reqPath)) return true
  if (reqPath === '/favicon.ico' || reqPath === '/favicon.svg' || reqPath === '/icons.svg') return true
  return false
}
